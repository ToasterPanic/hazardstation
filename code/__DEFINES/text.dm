...
#define MAPTEXT_GRAND9K(text) {"<span style='font-family: \"Geo\"; font-size: 6pt; -dm-text-outline: 1px black'>[##text]</span>"}
...
/// Test Font - Size options: 6pt 12pt 18pt.
#define MAPTEXT_GEO(text) {"<span style='font-family: \"Geo\"; font-size: 12pt; -dm-text-outline: 1px black'>[##text]</span>"}
